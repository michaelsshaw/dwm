...
static const char *shutdowncmd[] = { "yesno", "Shutdown?", "poweroff", NULL };
static const char *rebootcmd[] = { "yesno", "Reboot?", "sudo systemctl reboot", NULL };
static const char *termcmd[]  = { "alacritty", NULL };
static const char *ffxcmd[] = { "brave", NULL };

static Key keys[] = {
	/* modifier                     key        function        argument */
	{ MODKEY|ShiftMask,             XK_Return, spawn,          {.v = dmenucmd } },
	{ MODKEY,		        XK_Return, spawn,          {.v = termcmd } },
	{ MODKEY,			XK_g,	   spawn,          {.v = ffxcmd } },
	...
	{ MODKEY, 			XK_p, 	   spawn, 	   SHCMD("xdotool type $(grep -v '^#' ~/scripts/bookmarks | dmenu -i -l 20 | cut -d' ' -f1)") },
	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
